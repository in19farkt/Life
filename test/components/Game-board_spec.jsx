...
describe('<GameBoard/>', () => {
    ...
    it('перерисовывает GameBoard при изменении состояния', function () {
        let state = {
            width: 5,
            height: 5,
            cells: fromJS([
        ...
        let wrapper = mount(<GameBoard {...state}/>);
    ...
    it('корректно задает живые клетки', function () {
        let state = {
            width: 5,
            height: 5,
            cells: fromJS([
    ...
    it('событие onClick на клетках вызывает обработчик', function () {
